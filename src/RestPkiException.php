 ...
 *
 * The exception that occurs when requesting RestPki and some error has occurred
 * on server. It contains the information of this error.
 *
 * @property $errorCode string The code of error that occurred on RestPki.
...
class RestPkiException extends RestException
{
     ...
     * @var string
     *
     * The code of the error that occurred on RestPki.
     */
    private $_errorCode;
     ...
     * @var string
     *
     * The explanation of the error that occurred on RestPki.
     */
    private $_errorMessage;

    /**
     * RestPki Exception constructor.
     *
     * @param $verb string The HTTP method used at the request.
     * @param $url string The request URL.
     * @param $model mixed The error model provided by RestPki.
    ...
    public function __construct(
        ...
        $message = "RestPki API error {$model->code}: {$model->message}";
