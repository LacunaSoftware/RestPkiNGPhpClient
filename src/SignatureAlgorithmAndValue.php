 ...
 *
 * @property-read SignatureAlgorithm $algorithm
...
class SignatureAlgorithmAndValue
{
    ...
    {
        if (isset($model->algorithmIdentifier->algorithm)) {
            $this->_algorithm = SignatureAlgorithm::getInstanceByApiAlgorithm($model->algorithmIdentifier->algorithm);
        } else if (isset($model->algorithmIdentifier->algorithmObj)) {
            $this->_algorithm = $model->algorithmIdentifier->algorithmObj;
        }
